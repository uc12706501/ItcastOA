    ...
    <div id="Title_bar_Head">
        ...
        <div id="Title"><!--页面标题-->
            <img border="0" width="13" height="13"
                 src="${pageContext.request.contextPath}/style/images/title_arrow.gif"/> 【${forum.name}】中的主题列表
        </div>
            ...
            <table width="100%" border="0" cellspacing="0" cellpadding="0">
                ...
                <s:iterator value="#topicList">
                    <tr height="35" id="d0" class="template">
                        ...
                        <td class="Topic"><s:a cssClass="Default" action="topic_show?id=%{id}">${title}</s:a>
                        </td>
