            ...
            <div class="ItemBlock">
                <table cellpadding="0" cellspacing="0" class="mainForm">
                    <tr>
                        ...
                        <td>
                            <s:select list="#departmentList" cssClass="SelectStyle" name="departmentId"
            ...
            <div class="ItemBlock">
                <table cellpadding="0" cellspacing="0" class="mainForm">
                    <tr>
                        <td width="100">岗位</td>
                        <td>
                            <s:select list="#roleList" name="roleids" multiple="true" listKey="id" listValue="name"
                                      headerKey="" headerValue="==请选择职位==" cssClass="SelectStyle">
                            </s:select>
                            按住Ctrl键可以多选或取消选择
                        </td>
                    </tr>
