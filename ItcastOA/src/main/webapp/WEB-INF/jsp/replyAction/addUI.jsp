        ...
        <center>
            <div class="ItemBlock_Title1">
                <div width=85% style="float:left">
                    ...
                    <font class="MenuPoint"> &gt; </font>
                    <s:a action="topic_show?id=%{#topic.forum.id}">${topic.forum.name}</s:a>
                    <font class="MenuPoint"> &gt;&gt; </font>
                    帖子回复
                </div>
            </div>
                    ...
                    <tr>
                        ...
                        <td class="InputAreaBg">
                            <div class="InputContent">
                                <s:textfield name="title" cssclass="InputStyle" cssstyle="width:100%"
                                       value="回复：%{#topic.title}"/></div>
                        </td>
                    </tr>
                    <tr height="240">
                        <td class="InputAreaBg">
                        ...
                        <td class="InputAreaBg">
                            <div class="InputContent"><s:textarea name="content"></s:textarea></div>
                        </td>
                    </tr>
                    <tr height="30">
